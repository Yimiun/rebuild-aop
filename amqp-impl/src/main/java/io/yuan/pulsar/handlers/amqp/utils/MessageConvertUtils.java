...
//            setProp(builder, PROP_DELIVERY_MODE, 1);
//            setProp(builder, PROP_PRIORITY_PRIORITY, 1);
...
//    }
//
//    private static void setProp(TypedMessageBuilder builder, String propName, Object value)
//            throws UnsupportedEncodingException {
//        if (value != null) {
...
//        ByteBuf payload = msg.getDataBuffer().slice();
//
