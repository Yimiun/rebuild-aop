...
public interface ExchangeService {
    ...
    CompletableFuture<Optional<Exchange>> getExchange(String name, String tenantName, String namespaceName, boolean refresh);
    ...
    CompletableFuture<Void> removeExchange(String name, String tenantName, String namespaceName);
}
